...
export const ServerOwnerGeneration = makeEntityId("ServerOwnerGeneration");
export type ServerOwnerGeneration = typeof ServerOwnerGeneration.Type;
export const ProviderSessionGeneration = makeEntityId("ProviderSessionGeneration");
export type ProviderSessionGeneration = typeof ProviderSessionGeneration.Type;

...
/**
 * Streamable HTTP path serving the T3 Chat Helper toolkits: everything on
 * `/mcp` plus the typed environment API bridge. Only credentials carrying the
 * `environment` capability may use it, and only helper-thread credentials are
 * issued with that capability and this endpoint.
 */
export const MCP_HELPER_HTTP_PATH = "/mcp/helper";

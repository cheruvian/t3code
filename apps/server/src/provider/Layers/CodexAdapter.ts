...
interface CodexAdapterSessionContext {
  ...
  readonly progress: CodexSessionProgressCoalescer;
  readonly eventFiber: Fiber.Fiber<void, never>;
  stopped: boolean;
}

interface CodexSessionProgressCoalescer {
  readonly offerItem: (key: string, value: ProviderRuntimeEvent) => Effect.Effect<void>;
  readonly offerTokenUsage: (key: string, value: ProviderRuntimeEvent) => Effect.Effect<void>;
  readonly flush: (key: string) => Effect.Effect<void>;

...
import Migration0039 from "./Migrations/039_ProviderSessionGenerations.ts";
import Migration0040 from "./Migrations/040_ServerDrainState.ts";
...
export const migrationEntries = [
  ...
  [39, "ProviderSessionGenerations", Migration0039],
  [40, "ServerDrainState", Migration0040],
] as const;

export const helperIcon = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" role="img" aria-labelledby="title description">
  ...
  <path d="M77 31 49 73c-8 12-5 27 7 34 12 8 27 4 35-8l21-32c5-8 3-19-5-24-8-5-19-3-24 5L62 80c-2 4-1 9 3 11 4 3 9 1 12-3l18-27" fill="none" stroke="#60a5fa" stroke-width="11" stroke-linecap="round"/>
  <circle cx="88" cy="51" r="4" fill="#fff"/><circle cx="101" cy="59" r="4" fill="#fff"/>

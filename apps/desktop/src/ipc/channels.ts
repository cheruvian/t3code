...
export const SAFE_SHUTDOWN_REQUEST_CHANNEL = "desktop:safe-shutdown-request";
export const SAFE_SHUTDOWN_RESOLVE_CHANNEL = "desktop:safe-shutdown-resolve";
...
export const RENDERER_HEARTBEAT_CHANNEL = "desktop:renderer-heartbeat";
export const CAPTURE_RENDERER_CPU_PROFILE_CHANNEL = "desktop:capture-renderer-cpu-profile";
...
export const GET_CLOUDFLARED_TUNNEL_STATE_CHANNEL = "desktop:get-cloudflared-tunnel-state";
export const SET_CLOUDFLARED_TUNNEL_CHANNEL = "desktop:set-cloudflared-tunnel";

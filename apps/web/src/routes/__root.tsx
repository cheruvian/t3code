...
import { ServerDrainBanner } from "../components/ServerDrainBanner";
import { DesktopSafeShutdownCoordinator } from "../components/DesktopSafeShutdownCoordinator";
  ...
  return (
    <ToastProvider>
      <AnchoredToastProvider>
        ...
        <DesktopSafeShutdownCoordinator />
        <ServerDrainBanner />

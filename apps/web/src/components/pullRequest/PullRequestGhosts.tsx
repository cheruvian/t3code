 ...
 * and a detail panel opening — use opacity-pulsing bars in the geometry of the content they stand for.
 * Diff loading uses the shared diff-panel skeleton instead.
 */
...
export function PullRequestListGhost({
  ...
  return (
    <div
      ...
      className="animate-status-pulse space-y-0.5 motion-reduce:animate-none"
    >
      {caption ? (
...
export function PullRequestDetailGhost() {
  return (
    <div
      ...
      className="animate-status-pulse flex h-full min-h-0 flex-col overflow-hidden bg-background motion-reduce:animate-none"
    >
...
export function PullRequestPeopleGhost({ rows = 4 }: { rows?: number }) {
  return (
    <div
      ...
      className="animate-status-pulse space-y-1 p-1 motion-reduce:animate-none"
    >
      {Array.from({ length: rows }, (_, index) => (
...
export function PullRequestTimelineGhost({ rows = 6 }: { rows?: number }) {
  return (
    <div
      ...
      className="animate-status-pulse px-4 py-5 motion-reduce:animate-none"
    >
...
export function PullRequestConversationGhost({ rows = 3 }: { rows?: number }) {
  return (
    <div
      ...
      className="animate-status-pulse space-y-4 py-2 motion-reduce:animate-none"
    >
      {Array.from({ length: rows }, (_, index) => (

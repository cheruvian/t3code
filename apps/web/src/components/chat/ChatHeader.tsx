...
export const ChatHeader = memo(function ChatHeader({
  ...
  const headerActions = (
    <>
      ...
      {showOpenInPicker && (
        <>
          {actionsCollapsed && resolvedProjectScripts && <MenuSeparator />}
          <OpenInPicker
            presentation={actionsCollapsed ? "menu" : "toolbar"}
            environmentId={activeThreadEnvironmentId}
            keybindings={keybindings}
      ...
      {activeProjectName && gitCwd && (
        <>
          {actionsCollapsed && (resolvedProjectScripts || showOpenInPicker) && <MenuSeparator />}
          <GitActionsControl
            presentation={actionsCollapsed ? "menu" : "toolbar"}
            gitCwd={gitCwd}
      ...
      >
        <Menu open={actionsCollapsed && actionsOpen} onOpenChange={setActionsOpen}>
          <MenuTrigger
            className={
              actionsCollapsed &&
              (resolvedProjectScripts || showOpenInPicker || (activeProjectName && gitCwd))
                ? undefined
                : "hidden"
            }
